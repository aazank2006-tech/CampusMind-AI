...
class Chatbot:
    def __init__(self, api_key: Optional[str] = None,
        ...
        # choice into every other session running on the same server process.
    ...
    def set_persona(self, name: str, prompt: str, reset_history: bool = False):
        """
        Switch the active persona for this session's bot instance.
        Set reset_history=True if each persona should start a clean conversation.
        """
